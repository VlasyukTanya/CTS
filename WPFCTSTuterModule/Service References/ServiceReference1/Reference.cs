...
namespace WPFCTSTuterModule.ServiceReference1 {
    ...
    public interface IServiceCTS {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceCTS/addUser", ReplyAction="http://tempuri.org/IServiceCTS/addUserResponse")]
        void addUser(string name, string passwd, string realName, string email, int roleId, int groupId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceCTS/addUser", ReplyAction="http://tempuri.org/IServiceCTS/addUserResponse")]
        System.Threading.Tasks.Task addUserAsync(string name, string passwd, string realName, string email, int roleId, int groupId);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceCTS/GetTutorsDataTable", ReplyAction="http://tempuri.org/IServiceCTS/GetTutorsDataTableResponse")]
        System.Threading.Tasks.Task<System.Data.DataTable> GetTutorsDataTableAsync();
        ...
        System.Data.DataTable GetGroupsDataTable();
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceCTS/setInfo", ReplyAction="http://tempuri.org/IServiceCTS/setInfoResponse")]
        void setInfo(int userId, string s, string s1);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceCTS/setInfo", ReplyAction="http://tempuri.org/IServiceCTS/setInfoResponse")]
        System.Threading.Tasks.Task setInfoAsync(int userId, string s, string s1);
    }
    ...
    public partial class ServiceCTSClient : System.ServiceModel.ClientBase<WPFCTSTuterModule.ServiceReference1.IServiceCTS>, WPFCTSTuterModule.ServiceReference1.IServiceCTS {
        ...
        public void addUser(string name, string passwd, string realName, string email, int roleId, int groupId) {
            base.Channel.addUser(name, passwd, realName, email, roleId, groupId);
        }
        
        public System.Threading.Tasks.Task addUserAsync(string name, string passwd, string realName, string email, int roleId, int groupId) {
            return base.Channel.addUserAsync(name, passwd, realName, email, roleId, groupId);
        }
        ...
        public System.Threading.Tasks.Task<System.Data.DataTable> GetTutorsDataTableAsync() {
            return base.Channel.GetTutorsDataTableAsync();
        }
        
        public System.Data.DataTable GetGroupsDataTable() {
            return base.Channel.GetGroupsDataTable();
        }
        ...
        public void setInfo(int userId, string s, string s1) {
            base.Channel.setInfo(userId, s, s1);
        }
        
        public System.Threading.Tasks.Task setInfoAsync(int userId, string s, string s1) {
            return base.Channel.setInfoAsync(userId, s, s1);
        }
    }
}
